package com.example.mike4christ.cryptocompare.BitcoinCard;
//Hi.....THis is Coded By Alu Michael(alumichael9@gmail.com)...Check it Out
...
import com.example.mike4christ.cryptocompare.About;
import com.example.mike4christ.cryptocompare.R;
...
public class Bitcoin_Card extends AppCompatActivity {
    ...
    public void Convert_Btc(){
        btc_logo.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_about:
                Intent intent=new Intent(Bitcoin_Card.this,About.class);
                startActivity(intent);
                break;
