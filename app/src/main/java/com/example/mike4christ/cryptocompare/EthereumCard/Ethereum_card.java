package com.example.mike4christ.cryptocompare.EthereumCard;
...
public class Ethereum_card extends AppCompatActivity {
    ...
    public void Convert_Eth(){
        eth_logo.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_about:
                Intent intent=new Intent(Ethereum_card.this,About.class);
                startActivity(intent);
                break;
